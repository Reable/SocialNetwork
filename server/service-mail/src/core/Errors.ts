...
class MailError extends BadRequestError {
    static override STATUS_TEXT = 'Mail error';
    static override CODE = 'MAIL_ERROR';
...
export { ServiceError, BadRequestError, ValidationError, MailError }